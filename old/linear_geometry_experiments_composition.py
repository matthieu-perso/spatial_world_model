...
# test_sentences = generate_single_sentence_dataset(test_objects, relations, verbose=VERBOSE)   # to test on unseen objects
...
# get directions compositional properties
